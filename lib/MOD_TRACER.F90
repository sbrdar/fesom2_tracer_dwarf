...
real(kind=MP), allocatable         :: del_ttf(:,:)
real(kind=MP), allocatable         :: del_ttf_advhoriz(:,:), del_ttf_advvert(:,:)
...
real(kind=MP), allocatable, dimension(:,:,:)  :: dvd_trflx_hor, dvd_trflx_ver

!_______________________________________________________________________________
! The fct part
real(kind=MP),allocatable,dimension(:,:)      :: fct_LO          ! Low-order solution
real(kind=MP),allocatable,dimension(:,:)      :: adv_flux_hor    ! Antidif. horiz. contrib. from edges / backup for iterafive fct scheme
real(kind=MP),allocatable,dimension(:,:)      :: adv_flux_ver    ! Antidif. vert. fluxes from nodes    / backup for iterafive fct scheme
