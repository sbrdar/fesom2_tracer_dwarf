...
!==========================================================
MODULE o_PARAM
! Working precision - configurable via preprocessor
#ifdef USE_HALF_PRECISION
integer, parameter            :: WP=2        ! Half precision (FP16)
...
integer		                  :: mstep
real(kind=MP), parameter      :: pi=3.14159265358979_MP
real(kind=MP), parameter      :: rad=pi/180.0_MP
...
real(kind=MP), parameter      :: r_earth=6367500.0_MP
real(kind=MP), parameter      :: omega=2*pi/(3600.0_MP*24.0_MP)
...
real(kind=MP)                 :: scale_area=2.0e8_MP
