module restart_derivedtype_module
    interface
        subroutine write_all_bin_restarts(ctarr, path_in, pathi_in, partit, mesh, dynamics, tracers)
            use MOD_DYN
            use MOD_TRACER
            use MOD_PARTIT
            use MOD_MESH
        ...
        subroutine read_all_bin_restarts(path_in, partit, mesh, dynamics, tracers)
            use MOD_DYN
            use MOD_TRACER
            use MOD_PARTIT
            use MOD_MESH
