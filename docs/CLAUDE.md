...
| Purpose | File |
|---|---|
| Precision parameters (WP, MP) | `lib/oce_modules.F90` — see [PRECISION.md](PRECISION.md) |
...
| C interface (optional) | `lib/tracer_c_interface.F90` — see [INTERFACES.md](INTERFACES.md) |
...
- [ARCHITECTURE.md](ARCHITECTURE.md) — directory layout, source file descriptions, build products
- [PRECISION.md](PRECISION.md) — mixed precision design (WP/MP), compiler support, FP16 details
- [INTERFACES.md](INTERFACES.md) — C-compatible API, Python wrapper, array layouts
- [VISUALIZATION.md](VISUALIZATION.md) — plotting scripts setup, usage, multi-precision comparison
- [CHANGES.md](CHANGES.md) — changelog

## Documentation maintenance

After implementing a feature that changes behavior, CLI options, file formats, or conventions, update the relevant docs listed above. Verify documentation integrity periodically — if code and docs have diverged, fix the docs before moving on.
